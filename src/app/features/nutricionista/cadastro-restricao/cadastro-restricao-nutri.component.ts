...
@Component({
    ...
    templateUrl: './cadastro-restricao-nutri.component.html'
})
export class CadastroRestricaoNutriComponent implements OnInit {
    ...
    save(): void {
        if (this.restricaoForm.valid) {
            ...
            this.nutriService.createRestricao(payload)
